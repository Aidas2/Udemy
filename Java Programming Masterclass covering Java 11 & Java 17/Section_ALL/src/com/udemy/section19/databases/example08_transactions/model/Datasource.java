package com.udemy.section19.databases.example08_transactions.model;
...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:src/com/udemy/section19/databases/example08_transactions/" + DB_NAME;
    ...
    //constant for prepared statement:
    public static final String QUERY_VIEW_SONG_INFO_PREP = "SELECT " + COLUMN_ARTIST_NAME + ", " +
            COLUMN_SONG_ALBUM + ", " + COLUMN_SONG_TRACK + " FROM " + TABLE_ARTIST_SONG_VIEW +
            " WHERE " + COLUMN_SONG_TITLE + " = ?";
    // SELECT name, album, track FROM artist_list WHERE title = ?   // ? is placeholder (witch will be replaced with value)

    //constants for transactions (insert record):                                                   //STEP#1
    ...
    public static final String INSERT_SONGS = "INSERT INTO " + TABLE_SONGS +
            ...
            ") VALUES(?, ?, ?)";                                // ? is placeholder (witch will be replaced with value)
    //constants for transactions (checking if already exist):
    public static final String QUERY_ARTIST = "SELECT " + COLUMN_ARTIST_ID + " FROM " +
            TABLE_ARTISTS + " WHERE " + COLUMN_ARTIST_NAME + " = ?";

    public static final String QUERY_ALBUM = "SELECT " + COLUMN_ALBUM_ID + " FROM " +
            TABLE_ALBUMS + " WHERE " + COLUMN_ALBUM_NAME + " = ?";
    // !!! MISSING QUERY FOR CHECKING IF SONG ALREADY EXIST !!! (unless there may by two songs with same name in one album ?)

    private Connection conn;

    private PreparedStatement querySongInfoView;

    //for transactions:                                                                         //STEP#2
    ...
    */
    ...
    public void insertSong(String title, String artist, String album, int track) {
        ...
        try {
            ...
            insertIntoSongs.setInt(3, albumId); //write 8 and see what errors are generated
