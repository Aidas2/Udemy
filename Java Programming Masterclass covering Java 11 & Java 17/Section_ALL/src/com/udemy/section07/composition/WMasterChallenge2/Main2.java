...
public class Main2 {
    ...
    public static void main(String[] args) {
        Hamburger2 hamburger = new Hamburger2("Basic", "White", "Sausage", 3.0);
        hamburger.addAddition1("lettuce", 0.10);
        hamburger.addAddition2("tomato", 0.20);
        hamburger.addAddition3("carrot", 0.30);
        hamburger.addAddition4("cucumber", 0.10);
        hamburger.countAdditions();

        System.out.println("================================================");

        HealthyBurger2 healthyBurger = new HealthyBurger2("Turkey", 5);
        healthyBurger.addAddition1("lettuce", 0.10);
        healthyBurger.addAddition2("tomato", 0.20);
        healthyBurger.addAddition3("carrot", 0.30);
        healthyBurger.addAddition4("cucumber", 0.10);
        healthyBurger.countAdditions();
        healthyBurger.addAddition5("celery", 1.5);
        healthyBurger.addAddition6("spinach", 2.5);
        healthyBurger.countAdditions();


        System.out.println("================================================");

        DeluxeHamburger2 deluxeHamburger = new DeluxeHamburger2();
        deluxeHamburger.addAddition1("Coca-Cola", 0.50);
        deluxeHamburger.countAdditions();
