...
public class Main1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(secondString.replaceAll("^abcDeee", "YYY"));// ^ - looks only in beginning
        ...
        System.out.println(newAlphanumeric.replaceAll("[^ej]", "X"));   //  [^] - NOT ej (replaces all except ej)
        ...
        System.out.println(newAlphanumeric.replaceAll("\\d", "X")); //replaces any digit (finds any digit)
        System.out.println(newAlphanumeric.replaceAll("\\D", "X")); //replaces all non digit (finds any non digit)
        ...
        System.out.println(newAlphanumeric.replaceAll("\\w", "X")); //replaces non w (white space), (A-Z, a-z, 0-9, _ ))
