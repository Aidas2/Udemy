...
public class Main2 {
    public static void main(String[] args) {
        ...
        while(groupMatcher.find()) {
            System.out.println("Occurrence: " + groupMatcher.group(1)); //first group (tag h2)
        }
        ...
        while(h2TextMatcher.find()) {
            System.out.println("Occurrence: " + h2TextMatcher.group(2)); //second group (text between tags h2)
        }
