package com.udemy.section12.collections.lecture151_CHALLENGETim;
...
public class SetChallenge {
    public static void main(String[] args) {
        /*
        Modify the previous HeavenlyBody example01 so that the HeavenlyBody
        ...
        an asteroid also called "BetaMinor", for example01.
