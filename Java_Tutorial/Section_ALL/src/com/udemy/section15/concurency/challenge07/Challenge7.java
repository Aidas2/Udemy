package com.udemy.section15.concurency.challenge07;
...
class BankAccount {
    ...
    public boolean withdraw(double amount) {
        if (lock.tryLock()) {   // there was no unlock() !!!
            try {               // step_01 add another try
                try {
                ...
                return true;
            } finally {         // step_02 add finally with unlock()
                lock.unlock();
            }
        }
        return false;
